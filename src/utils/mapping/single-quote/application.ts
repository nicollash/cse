...
export const parseQuoteResponse = (quoteResponse: QuoteResponse): QuoteDetail => {
  try {
    ...
    return {
      ...
      vehicles: quoteResponse.infoReq || !quoteResponse.DTOApplication[0].DTOLine[0].DTORisk ? [] : quoteResponse.DTOApplication[0].DTOLine[0].DTORisk?.map((risk) =>
        parseRisk(risk),
      ),
      ...
      planDetails: convertApplicationToPlan(quoteResponse.DTOApplication[0], payPlan, 'Standard'),

      lineInfo: {
        multiPolicyDiscountInd: quoteResponse.DTOApplication[0].DTOLine[0].MultiPolicyDiscountInd,
        relatedPolicyNumber: quoteResponse.DTOApplication[0].DTOLine[0].RelatedPolicyNumber,
        multiPolicyDiscount2Ind: quoteResponse.DTOApplication[0].DTOLine[0].MultiPolicyDiscount2Ind,
        relatedPolicyNumber2: quoteResponse.DTOApplication[0].DTOLine[0].RelatedPolicyNumber2
      },
      basicPolicyInfo: {
        programInd: quoteResponse.DTOApplication[0].DTOBasicPolicy[0].ProgramInd,
        affinityGroupCd: quoteResponse.DTOApplication[0].DTOBasicPolicy[0].AffinityGroupCd
      },
      communicationInfo: {
        email: quoteResponse.DTOApplication[0].DTOInsured[0].PartyInfo[0].EmailInfo[0].EmailAddr ? quoteResponse.DTOApplication[0].DTOInsured[0].PartyInfo[0].EmailInfo[0].EmailAddr : ''
        ,
        phone: quoteResponse.DTOApplication[0].DTOInsured[0].PartyInfo[0].PhoneInfo[0].PhoneNumber ?
      ...
      additionalInterest: quoteResponse.DTOApplication[0].DTOAI ? quoteResponse.DTOApplication[0].DTOAI.map((dtoAi) => parseAdditionalInterestDTOtoAI(dtoAi)) : [],

      lossHistory: quoteResponse.DTOApplication[0].DTOLossHistory ? quoteResponse.DTOApplication[0].DTOLossHistory.map((dtoLh) => parseDTOtoLossHistorySingleQuote(dtoLh)) : [],

      validationError: [
        ...quoteResponse.DTOApplication[0].ValidationError || [], 
        ... (quoteResponse.DTOApplication[0].DTOLine[0].DTORisk ?  quoteResponse.DTOApplication[0].DTOLine[0].DTORisk?.map(risk => risk.DTOValidationError || []).reduce((acc, curVal) => acc.concat(curVal), []) : [])
      ],
...
export const getUpdatedDTOApplication = (
  ...
  try {
    ...
    //LineInfo
    result[0].DTOLine[0].MultiPolicyDiscountInd = quoteDetail.lineInfo.multiPolicyDiscountInd
    result[0].DTOLine[0].RelatedPolicyNumber = quoteDetail.lineInfo.multiPolicyDiscountInd ? ((quoteDetail.lineInfo.multiPolicyDiscountInd === 'No' || quoteDetail.lineInfo.multiPolicyDiscountInd === '') ? '' : quoteDetail.lineInfo.relatedPolicyNumber) : ''

    result[0].DTOLine[0].MultiPolicyDiscount2Ind = quoteDetail.lineInfo.multiPolicyDiscount2Ind
    result[0].DTOLine[0].RelatedPolicyNumber2 = quoteDetail.lineInfo.multiPolicyDiscount2Ind ? ((quoteDetail.lineInfo.multiPolicyDiscount2Ind === 'No' || quoteDetail.lineInfo.multiPolicyDiscount2Ind === '') ? '' : quoteDetail.lineInfo.relatedPolicyNumber2) : ''

    //BasicPolicyInfo
    result[0].DTOBasicPolicy[0].ProgramInd = quoteDetail.basicPolicyInfo.programInd
    result[0].DTOBasicPolicy[0].AffinityGroupCd = quoteDetail.basicPolicyInfo.programInd === 'Affinity Group' ? quoteDetail.basicPolicyInfo.affinityGroupCd : ''

    //CommunicationInfo
    result[0].DTOInsured[0].PartyInfo[0].EmailInfo[0].EmailAddr = quoteDetail.communicationInfo.email
    result[0].DTOInsured[0].PartyInfo[0].PhoneInfo[0].PhoneNumber = quoteDetail.communicationInfo.phone
