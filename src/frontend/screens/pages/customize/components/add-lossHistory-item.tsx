...
export const AddLossHistoryItem: FunctionComponent<Props> = ({
  ...
  const [edititStatus, setEditing] = useState<{
    editing: boolean;
    cancelled: boolean;
  }>({ editing: false, cancelled: false });
    ...
    <div css={[styles.container, styles.aiItem]} className={className}>
      <div>
        <div onClick={() => setCollapsed(!collapsed)} css={styles.heading}>
          <Text bold>{`#${item.LossHistoryNumber} - ${parseDate(
            item.LossDt
          )} - ${item.LossCauseCd}`}</Text>
        ...
        <div
          css={[
            !edititStatus.editing && styles.content,
                  ...
                  >
                    <Row>
                      <Col md={12} lg={6}>
                        <FormGroup
                          key="fg-LossDt"
                          label={
                            messages.LossHistoryModal.AddNewSection.LossDate
                          }
                    ...
                    <Row>
                      ...
                      <Col md={12} lg={4}>
                        <FormGroup
                          key="fg-TypeCd"
                          label={
                            messages.LossHistoryModal.AddNewSection.PolicyType
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                    ...
                    <Row>
                      <Col md={12} lg={4}>
                        <FormGroup
                          key="fg-LossAmt"
                          label={
                            messages.LossHistoryModal.AddNewSection.LossAmount
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                      ...
                      <Col md={12} lg={4}>
                        <FormGroup
                          key="fg-PaidAmt"
                          label={
                            messages.LossHistoryModal.AddNewSection.PaidAmount
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                      ...
                      <Col md={12} lg={4}>
                        <FormGroup
                          ...
                          label={
                            messages.LossHistoryModal.AddNewSection.VehicleVIN
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                    ...
                    <Row>
                      <Col md={12} lg={12}>
                        <FormGroup
                          key="fg-AtFaultCd"
                          label={
                            messages.LossHistoryModal.AddNewSection.AtFault
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                    ...
                    <Row>
                      <Col md={12} lg={4}>
                        <FormGroup
                          key="fg-DriverName"
                          label={
                            messages.LossHistoryModal.AddNewSection.DriverName
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                        >
                      ...
                      <Col md={12} lg={4}>
                        <FormGroup
                          ...
                          label={
                            messages.LossHistoryModal.AddNewSection
                              .LicenseNumber
                          }
                          css={[styles.linearLines, utils.mr(2)]}
                          textContainerClassName="linearLabelWithValidation"
                    ...
                    <Row>
                      <Col md={12} lg={12}>
                        <FormGroup
                          key="fg-Comment"
                          label={
                            messages.LossHistoryModal.AddNewSection.Comments
                          }
                          css={[
                            styles.linearLines,
                            styles.interestNameContainer,
                          ]}
                    ...
                    {formik.values.SourceCd != "CLUE" && (
                      <div css={styles.saveButton}>
                        <Button type="submit">
                          {messages.LossHistoryModal.AddNewSection.Save}
                        </Button>
                      </div>
                    )}
                  </form>
              ...
              <div>
                <div css={[styles.actionBar, utils.px(2)]}>
                  <div css={[styles.icon]}>
                    <FontAwesomeIcon
                      icon={
                        formik.values.SourceCd != "CLUE" ? faPencilAlt : faEye
                      }
                      css={[styles.iconCustom]}
                      title={
                        formik.values.SourceCd != "CLUE" ? "Edit" : "View more"
                      }
                      onClick={() => {
                ...
                <Row css={[styles.aiItemAligment]}>
                  <Col
                    md={12}
                    lg={4}
                    css={[styles.aiItemAligment, utils.mt("-1px")]}
                  >
