...
import { LossHistoryInfo, QuoteDetail } from "~/types";
...
import { lhConfig } from "~/frontend/utils/configuration/lossHistory";
import { AddLossHistoryItem } from "~/frontend/screens/pages/customize/components/add-lossHistory-item";
...
export const LossHistoryModal: FunctionComponent<Props> = ({
  ...
  const schema = () =>
    Yup.object().shape({
      ...
      LossCauseCd: Yup.string().required(
        messages.LossHistoryModal.Errors.LossCauseCd
      ),
      DriverName: Yup.string().required(
        messages.LossHistoryModal.Errors.DriverName
      ),
      AtFaultCd: Yup.string().required(
        messages.LossHistoryModal.Errors.AtFaultCd
      ),
    });
              ...
              >
                ...
                <Row>
                  <Col md={12} lg={6}>
                    <FormGroup
                      key="fg-LossDt"
                      label={messages.LossHistoryModal.AddNewSection.LossDate}
                      css={[styles.linearLines, utils.mr(2)]}
                  ...
                  <Col md={12} lg={6}>
                    <FormGroup
                      key="fg-LossCauseCd"
                      label={
                        messages.LossHistoryModal.AddNewSection.CauseOfLoss
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                ...
                <Row>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-ClaimNumber"
                      label={
                        messages.LossHistoryModal.AddNewSection.ClaimNumber
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="ClaimNumber" />
                    </FormGroup>
                  </Col>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-ClaimStatusCd"
                      label={
                        messages.LossHistoryModal.AddNewSection.ClaimStatus
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                  ...
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-CatastropheNumber"
                      label={
                        messages.LossHistoryModal.AddNewSection.CatastropheN
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="CatastropheNumber" />
                    </FormGroup>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-CarrierName"
                      label={
                        messages.LossHistoryModal.AddNewSection.CarrierName
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="CarrierName" />
                    </FormGroup>
                  </Col>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-TypeCd"
                      label={messages.LossHistoryModal.AddNewSection.PolicyType}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikSelect
                  ...
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-PolicyNumber"
                      label={
                        messages.LossHistoryModal.AddNewSection.PolicyNumber
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="PolicyNumber" />
                    </FormGroup>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-LossAmt"
                      label={messages.LossHistoryModal.AddNewSection.LossAmount}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="LossAmt" />
                    </FormGroup>
                  </Col>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-PaidAmt"
                      label={messages.LossHistoryModal.AddNewSection.PaidAmount}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput css={utils.mb(3)} name="PaidAmt" />
                    </FormGroup>
                  </Col>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-VehIdentificationNumber"
                      label={messages.LossHistoryModal.AddNewSection.VehicleVIN}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikInput
                ...
                <Row css={utils.mt(1)}>
                  <Col md={12} lg={12}>
                    <FormGroup
                      key="fg-AtFaultCd"
                      label={messages.LossHistoryModal.AddNewSection.AtFault}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikSelect
                ...
                <Row>
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-DriverName"
                      label={messages.LossHistoryModal.AddNewSection.DriverName}
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                      <FormikSelect
                  ...
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-DriverLicensedStateProvCd"
                      label={
                        messages.LossHistoryModal.AddNewSection.LicenseState
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                  ...
                  <Col md={12} lg={4}>
                    <FormGroup
                      key="fg-DriverLicenseNumber"
                      label={
                        messages.LossHistoryModal.AddNewSection.LicenseNumber
                      }
                      css={[styles.linearLines, utils.mr(2)]}
                      textContainerClassName="linearLabelWithValidation"
                    >
                ...
                <Row>
                  <Col md={12} lg={12}>
                    <FormGroup
                      key="fg-Comment"
                      label={messages.LossHistoryModal.AddNewSection.Comments}
                ...
                <Row>
                  <Col md={12} lg={12}>
                    <FormGroup
                      key="fg-LossDesc"
                      label={
                        messages.LossHistoryModal.AddNewSection.LossDescription
                      }
                      css={[styles.linearLines, styles.interestNameContainer]}
                      textContainerClassName="linearLabelWithValidationTextArea"
                      containerClassName="customNameContainer"
                ...
                <div css={styles.saveButton}>
                  <Button type="submit">
                    {messages.LossHistoryModal.AddNewSection.AddItem}
                  </Button>
                </div>
              </form>
            </FormikProvider>
