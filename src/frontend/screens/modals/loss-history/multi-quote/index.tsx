...
import { Button, Col, FormGroup, FormikDatePicker, FormikInput, FormikSelect, Modal, Row } from '~/frontend/components'
...
export const LossHistoryModal: FunctionComponent<Props> = ({
    ...
    useEffect(() => {           
        ...
        if(isOpen && !quoteDetail.planInfo[selectedPlan].isQuote){
