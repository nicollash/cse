...
import { Modal, FormGroup, Button, FormikSwitch, Hr, FormikSelect, FormikInput } from '~/frontend/components'
...
import { discountsConfig } from '~/frontend/utils/configuration/discounts'
